               ...
               <div class="card-body">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:DropDownList class="form-control" ID="DropDownList1" runat="server">
                              ...
                              <asp:ListItem Text="Madesh" Value="Madesh" />
                              <asp:ListItem Text="Gandaki" Value="Gandaki" />
                              <asp:ListItem Text="Bagmati" Value="Bagmati" />
                              <asp:ListItem Text="Pradesh No. 1" Value="Pradesh No. 1" />
                              <asp:ListItem Text="Karnali" Value="Karnali" />
                              <asp:ListItem Text="Sudaarpaschim" Value="Sudaarpaschim" />   
                           </asp:DropDownList>
                        </div>
                     </div>
                     <div class="col-md-4">
                  ...
                  <div class="row">
                     <div class="col-8 mx-auto">
                        <center>
                           <div class="form-group">
                              <asp:Button class="btn btn-primary btn-block btn-lg col-md-12" ID="Button1" runat="server" Text="Sign Up" />
                           </div>
                        </center>
                     </div>
                  </div>
